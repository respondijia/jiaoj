...
import com.respond.jiaoj.model.entity.*;
...
import com.respond.jiaoj.mapper.QuestionMapper;
...
* @createDate 2024-08-25 22:25:12
*/
@Service
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        // 创建时，参数不能为空
        if (add) {
            ThrowUtils.throwIf(StringUtils.isAnyBlank( title, content, (CharSequence)tags), ErrorCode.PARAMS_ERROR);
        }
        // 有参数则校验
